// IMPLEMENT THE OPERATIONS OF DOUBLY LINKED LIST STORING STRING VALUES (INSERT AT BEGIN,INSERT AT POS,INSERT AT END,DELETE AT BEGIN,DELETE AT END, DELETE AT POS, ISEMPTY, ISFULL, DISPLAY, SEARCH)
...
public:
    ...
    void deleteAtEnd() {
        ...
        Node* current = head;
        if (current->next == nullptr) { // Only one node
            delete head;
            head = nullptr;
            return;
        }
