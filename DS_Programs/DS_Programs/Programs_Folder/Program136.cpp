// IMPLEMENT THE OPERATIONS OF PRIORITY QUEUE DYNAMICALLY OF STRING (INSERT, DELETE, PEEK, ISEMPTY, ISFULL)
...
public:
    ...
    // Insert a string into the priority queue
    void insert(const std::string& value) {
        Node* newNode = new Node(value);

        // If queue is empty or new node has higher priority (lexicographically larger)
