// IMPLEMENT THE OPERATIONS OF SINGLE LINKED LIST STORING INTEGER VALUES (INSERT AT BEGIN,INSERT AT POS,INSERT AT END,DELETE AT BEGIN,DELETE AT END, DELETE AT POS, ISEMPTY, ISFULL, DISPLAY, SEARCH)
...
int delete1(struct node *start, int pos)
{
    if (pos < 0)
    {
        return 1;
...
int main()
{
    ...
    do
    {
        ...
        case 6:
            printf("ENTER INDEX : ");
            scanf("%d", &pos);
            delete1(start, pos) ? printf("FAILED TO DELETE\n\n") : printf("DELETED SUCCESSFULLY\n\n");
            break;
        case 7:
            break;
        case 8:
