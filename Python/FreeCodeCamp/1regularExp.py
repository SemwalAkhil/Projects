...
pattern8 = r"Lorem\s+Ipsum" # all lorem ipsum with any number of whitespace between them
pattern9 = r"[0-9]+"     # any character sequence with one or more numbers
pattern10 = r"[AEIOU]+"  # one or more capital vowel characters
pattern11 = r"[AEIOU]+[a-z]+" # Word starting with a capital vowel and having one or more small letters
pattern12 = r"Lorem.+Ipsum" # greedy matching for character sequence starting with lorem ending with ipsum
pattern13 = r"Lorem.+?Ipsum"# non-greedy matching for character sequence starting with lorem ending with ipsum
pattern14 = r"[4-5]+\s[B-C]+" 
pattern14 = r"([4-5]+\s[B-C]+)" # fine tuning extraction 
...
# match = re.findall(pattern9,text)
# print(match)

# match = re.findall(pattern10,text)
# print(match)

# match = re.findall(pattern11,text)
# print(match)

# match = re.findall(pattern12,text)
# print(match)

# match = re.findall(pattern13,text)
# print(match)

# match = re.findall(pattern14,text)
# print(match)

# s = 'A message from csev@umich.edu to cwen@iupui.edu about meeting @2PM'
# lst = re.findall('\\S+@\\S+', s) # when not using raw string we need to use '\' before escape sequence here '\S'
# print(lst)