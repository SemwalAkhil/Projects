...
<br></br><br></br>
Kesri Foundation is certified under <span className='font-extrabold text-blue-900'>ISO 21001:2018, 45001:2018, and 9001:2015</span> for its <span className='font-extrabold text-blue-900'>Academic Reinforcement Program, Quality Assessment Program, Psychometric Assessment Program, and Theatre in Education</span>. Additionally, the foundation is a proud member of the <span className='font-extrabold text-blue-900'>Asia Pacific Career Development Association (APCDA)</span>, the <span className='font-extrabold text-blue-900'>International Association for Applied Psychology (IAAP)</span>, and registered under <span className='font-extrabold text-blue-900'>MSME India</span> and <span className='font-extrabold text-blue-900'>trademark holders</span> which reinforces its dedication to delivering high standards in educational and psychological services.
      </p>
